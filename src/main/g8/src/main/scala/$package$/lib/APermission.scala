...
object APermission {
  lazy val wildcardToken  = AppConfig.permissionWilcardToken.vend
  lazy val partDivider    = AppConfig.permissionPartDivider.vend
  lazy val subpartDivider = AppConfig.permissionSubpartDivider.vend
