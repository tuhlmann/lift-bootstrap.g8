...
trait Locs {
  private lazy val userMeta      = AppConfig.authUserMeta.vend

  private lazy val indexUrl      = AppConfig.indexUrl.vend
  private lazy val loginUrl      = AppConfig.loginUrl.vend
  private lazy val logoutUrl     = AppConfig.logoutUrl.vend
